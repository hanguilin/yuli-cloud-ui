...
<div>
  <el-dialog
    ...
    <el-form :model="inputForm" v-loading="loading" :class="method==='view'?'readonly':''" :disabled="method==='view'" :rules="dataRule" ref="inputForm" @keyup.enter.native="doSubmit()"
          ...
          <el-form-item label="上级菜单" prop="parentId">
           ...
           <el-form-item :label="typeList[inputForm.type] + '名称'" prop="title">
            <el-input maxlength="50" v-model="inputForm.title" :placeholder="typeList[inputForm.type] + '名称'"></el-input>
          </el-form-item>
          <el-form-item v-if="inputForm.type === '1' || inputForm.type === '2' || inputForm.type === '3'" label="链接地址" prop="path">
              <el-input maxlength="1000" v-model="inputForm.path" placeholder="请填写路由路径或者超链接"></el-input>
          </el-form-item>
          ...
          <el-form-item v-if="inputForm.type !== '2' && inputForm.type !== '3'"  label="可见" prop="visible">
            <el-radio-group v-model="inputForm.visible">
              <el-radio v-for="item in [{ id: '1', label: '显示', value: '1' }, { id: '2', label: '隐藏', value: '0' }]" :label="item.value" :key="item.id">{{item.label}}</el-radio>
            </el-radio-group>
          </el-form-item>
          ...
          <el-form-item label="备注" prop="remark">
            <el-input v-model="inputForm.remark" maxlength="200" type="textarea"
  ...
  <SelectIcon ref="icon" @getValue="value => inputForm.icon = value"></SelectIcon>
</div>
</template>
