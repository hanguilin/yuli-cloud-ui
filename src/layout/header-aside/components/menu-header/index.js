...
export default {
  ...
  render (h) {
    return <div
      flex="cross:center"
      class={ { 'yuli-header-menu': true, 'is-scrollable': this.isScroll } }
      ref="page">
      <div
        ref="content"
        class="yuli-header-menu__content"
        flex-box="1"
        flex>
        <div
          class="yuli-header-menu__scroll"
          flex-box="0"
