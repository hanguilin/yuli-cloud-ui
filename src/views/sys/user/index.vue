  ...
  <div>
    ...
    <el-col :span="19">
     ...
     <el-form :inline="true" v-show="isSearchCollapse" class="query-form" ref="searchForm" :model="searchForm" @keyup.enter.native="refreshList()" @submit.native.prevent>
         <el-form-item prop="username">
          <el-input size="small" v-model="searchForm.username" placeholder="账号" clearable></el-input>
         </el-form-item>
         <el-form-item prop="nickname">
           <el-input size="small" v-model="searchForm.nickname" placeholder="用户名" clearable></el-input>
        </el-form-item>
      <el-form-item>
    ...
    <el-table
      ...
      <el-table-column
        ...
        label="账号">
        <template slot-scope="scope">
          <el-link  type="primary" :underline="false"  @click="view(scope.row.id)">{{scope.row.username}}</el-link>
        </template>
      </el-table-column>
      <el-table-column
        prop="nickname"
...
export default {
  ...
  methods: {
    ...
    refreshTree () {
      this.$http.get('/sys/office/treeData').then(({ data }) => {
    ...
    resetSearch () {
      ...
      this.searchForm.office.id = ''
      this.selectOfficeName = ''
      this.searchForm.position.personnelName = ''
